            ...
            <div id="content">
                ...
                <div class="container-fluid" id="app">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form enctype="multipart/form-data" action="../api/imgCono.php" method="POST" class="col-md-6">
        ...
        let app =	new Vue({
           ...
           methods: {
            cargarImagenes:function(){
                axios.get("../api/imagenes_conocenos.php?accion=imgEventos")
                ...
                confirmButtonText: 'Si, Eliminar!'
                    ...
                    if (result.value) {
                        axios.post("../api/imagenes_conocenos.php?accion=eliminar", {
                            ide: id
                        }).then(function(response){
