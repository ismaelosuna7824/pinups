                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">titulo Ingles</label>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea class="form-control" name="" id="" cols="30" rows="10" v-model="textoes"></textarea>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">texto Ingles</label>
                                                <textarea class="form-control" name="" id="" cols="30" rows="10" v-model="textoen"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">Agradecimiento</label>
                                                <textarea class="form-control" name="" id="" cols="30" rows="3" v-model="agradecimientoes"></textarea>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Agradecimiento Ingles</label>
                                                <textarea class="form-control" name="" id="" cols="30" rows="3" v-model="agradecimientoen"></textarea>
                                            </div>
                                        </div>
        ...
        methods: {
            guardar: function() {
                ...
                if (this.titulo != '') {
                    ...
                    axios.post("../api/franquicias.php?accion=updatecinco", {
                        ides : this.ides,
                        iden : this.iden,
            ...
            cargarDatos: function() {
                axios.post("../api/franquicias.php?accion=dseccioncinco")
                    .then(function(response) {
